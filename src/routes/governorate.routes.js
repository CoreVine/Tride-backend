...
router.route("/governorate").get(governoratesController.getAllGovernorates).post(
  // roleCheck(["admin", "manager"], "acc_type"),
  validate(governorateCreateSchema),
  governoratesController.createGovernorate
)

router.route("/governorate/search").get(governoratesController.searchGovernorates)

router.route("/governorate/paginated").get(governoratesController.getPaginatedGovernorates)

router.route("/governorate/:id").get(governoratesController.getGovernorateById).put(validate(governorateCreateSchema), governoratesController.updateGovernorate).delete(governoratesController.deleteGovernorate)
