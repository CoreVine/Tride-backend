...
const cityController = {
  ...
  async deleteCity(req, res, next) {
    try {
      ...
      const cityWithParentsDriversSchools = await CityRepository.findByIdWithParentsDriversSchools(id)
      if (cityWithParentsDriversSchools.parents && cityWithParentsDriversSchools.parents.length > 0 && cityWithParentsDriversSchools.schools && cityWithParentsDriversSchools.schools.length > 0 && cityWithParentsDriversSchools.drivers && cityWithParentsDriversSchools.drivers.length > 0) {
        logger.warn(
        ...
        throw new BadRequestError("Cannot delete a city that has drivers , parents ,schools. Delete it first.")
      }
